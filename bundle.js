...
/***/ function(module, exports, __webpack_require__) {
	  ...
	  _createClass(Post, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'form',
	        null,
	        _react2.default.createElement('h4', { className: 'error', ref: 'error' }),
	        _react2.default.createElement(
	          'p',
	          null,
	          _react2.default.createElement('input', { ref: 'name', placeholder: 'Name...' })
	        ),
	        _react2.default.createElement(
	          'p',
	          null,
	          _react2.default.createElement('textarea', { ref: 'msg', placeholder: 'Message...' })
	        ),
	        _react2.default.createElement(
	          'button',
	...
	var MessageList = function MessageList(_ref3) {
	  ...
	  var msgs = messages.map(function (data, cont) {
	    return _react2.default.createElement(Message, { key: cont, name: data.name, msg: data.msg });
	  });
	...
	function render() {
	  _reactDom2.default.render(_react2.default.createElement(MessageApp, { title: 'Message App', messages: store.getState() }), document.getElementById('container'));
	}
